...
// Hack for C++/VS not supporting dynamic array
#ifdef _MSC_VER
#define BOUNDS_W        PIMORONI_WORST_CASE_ROW_SIZE // Worse case MAX row size
#else
#define BOUNDS_W        bounds.w
#endif
