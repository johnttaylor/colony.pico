...
class ToolChain( base.ToolChain ):
    ...
    def __init__( self, exename, prjdir, build_variants, board, pico_root, default_variant='release', env_error=None ):
        ...
        self._clean_pkg_dirs.extend( ['pico', '_pico'] )
       ...
       #
        ...
        self._base_release.cppflags     = self._base_release.cppflags + ' -std=gnu++11 -fno-threadsafe-statics -fno-rtti -fno-exceptions -fno-unwind-tables -fno-use-cxa-atexit'
        ...
        self._base_release.linkflags    = f' {mcu} -mthumb -O3 -Wl,--build-id=none --specs=nosys.specs -Wl,-z,max-page-size=4096 -Wl,--gc-sections {wrapper_funcs} -Wl,--script={linker_script} bs2_default_padded_checksummed.S -Wl,-Map={exename}.elf.map' 
