...
class ToolChain( base.ToolChain ):
    ...
    #--------------------------------------------------------------------------
    def __init__( self, exename, prjdir, build_variants, board, pico_path, default_variant='release', env_error=None ):
        ...
        self._elf2uf2  = os.path.join( pico_path, 'tools', 'elf2uf2.exe' )
        self._pioasm   = os.path.join( pico_path, 'tools', 'pioasm.exe' )
        self._asm_ext  = 'asm'    
        self._asm_ext2 = 'S'   
        ...
        # Define paths
        sdk_src_path = os.path.join( pico_path, 'src' )
        ...
        board_header = os.path.join( pico_path, "src", "boards", "include", "boards", board + '.h' )

          
        # 
        common_flags                    = f' -O3 -DPICO_CONFIG_HEADER={board_header} -Os -mcpu=cortex-m0plus -mthumb -DPICO_TARGET_NAME=\\"{exename}\\" -DPICO_BOARD=\\"{board}\\" -DLIB_PICO_BIT_OPS=1 -DLIB_PICO_BIT_OPS_PICO=1 -DLIB_PICO_DIVIDER=1 -DLIB_PICO_DIVIDER_HARDWARE=1 -DLIB_PICO_DOUBLE=1 -DLIB_PICO_DOUBLE_PICO=1 -DLIB_PICO_FLOAT=1 -DLIB_PICO_FLOAT_PICO=1 -DLIB_PICO_INT64_OPS=1 -DLIB_PICO_INT64_OPS_PICO=1 -DLIB_PICO_MALLOC=1 -DLIB_PICO_MEM_OPS=1 -DLIB_PICO_MEM_OPS_PICO=1 -DLIB_PICO_PLATFORM=1 -DLIB_PICO_PRINTF=1 -DLIB_PICO_PRINTF_PICO=1 -DLIB_PICO_RUNTIME=1 -DLIB_PICO_STANDARD_LINK=1 -DLIB_PICO_STDIO=1 -DLIB_PICO_STDIO_UART=1 -DLIB_PICO_STDLIB=1 -DLIB_PICO_SYNC=1 -DLIB_PICO_SYNC_CORE=1 -DLIB_PICO_SYNC_CRITICAL_SECTION=1 -DLIB_PICO_SYNC_MUTEX=1 -DLIB_PICO_SYNC_SEM=1 -DLIB_PICO_TIME=1 -DLIB_PICO_UTIL=1 -DPICO_BUILD=1'
        ...
        self._base_release.asminc       = self._base_release.asminc + common_flags + self._base_release.inc
        #self._base_release.asmflags     = self._base_release.asmflags +common_flags
        ...
        linker_script                   = os.path.join( pico_path, "rp2_common", "pico_standard_link", "memmap_default.ld" )
        bootstage2                      = os.path.join( pico_path, "rp2_common", "boot_stage2", "bs2_default_padded_checksummed.S" )
        self._base_release.linkflags    = f' -Wl,--build-id=none --specs=nosys.specs -Wl,-z,max-page-size=4096 -Wl,--gc-sections {wrapper_funcs} {bootstage2}' 
                                        
        # 
        self._base_release.firstobjs    = r'_BUILT_DIR_.pico\src\rp2_common\pico_standard_link'
