...
{
public:
    /** This method is used to set the LED's color value/state.
     */
    virtual void setColor( uint8_t redValue, uint8_t greenValue, uint8_t blueValue ) noexcept = 0;
    ...
    inline void setOff() { setColor( 0, 0, 0 ); }
