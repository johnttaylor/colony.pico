...
public:
    ...
    {
        return readData( &dstData, sizeof( Storm::Type::HvacRelayOutputs_T ), seqNumPtr );
    }
    ...
    inline uint16_t write( const Storm::Type::HvacRelayOutputs_T& srcData, LockRequest_T lockRequest = eNO_REQUEST ) noexcept
    {
        ...
        validate( newData );
        return writeData( &newData, sizeof( Storm::Type::HvacRelayOutputs_T ), lockRequest );
    }
...
public:
    /** This convenience method is used to read the MP contents and synchronize
        ...
        Note: The observer will be subscribed for change notifications after
              this call.
     */
    inline bool readAndSync( Storm::Type::HvacRelayOutputs_T& dst, Observer& observerToSync )
    {
        uint16_t seqNum;
